...
struct XsTransform {
	...
	inline mat4 matrix() const {
		return
			glm::translate(mat4(1.f), (glm::vec3)pos)*
			glm::rotate(mat4(1.f), rot.x/180.f*3.14f, glm::vec3(1, 0, 0))*
			glm::rotate(mat4(1.f), rot.y/180.f*3.14f, glm::vec3(0, 1, 0))*
			glm::rotate(mat4(1.f), rot.z/180.f*3.14f, glm::vec3(0, 0, 1))*
			glm::scale(mat4(1.f), (glm::vec3)scale)*
			glm::translate(mat4(1.f), (glm::vec3)origin);
	};
};
